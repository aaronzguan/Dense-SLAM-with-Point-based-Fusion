"""
    ...
    This script put together both ICP and fusion to construct dense-SLAM
    It starts with an initialization transformation and then use point-to-plane-based
    frame-to-model ICP to get the transformation between world and input image. 
    The point-based fusion constructs the dense Map with the transformation from ICP.
"""
